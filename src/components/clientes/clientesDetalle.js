        ...
        <div className="surface-card border-round shadow-2 p-4">
            ...
            <div className="p-fluid">
                <form onSubmit={handleSubmit} >
                    ...
                    <div className="p-row">
                        <Button label="Guardar" icon="pi pi-check" type="submit" className="p-col"/>
                        <Button label="Cancelar" icon="pi pi-times" className="p-button-text p-col" onClick={onCancelar} />
                    </div>
                </form>
            </div>
        </div>
